...
This file is Orisen's customer-facing language authority.
...
- waitlist copy
- customer messages
- investor-facing product summaries
- founder-led content
- launch copy
...
Orisen should not sound like a generic wellness gadget.
...
> Orisen is a sleep intervention device that starts by solving the gap between your alarm ringing and you actually leaving bed.

Short positioning:

> Orisen helps turn waking up from a willpower problem into a system.
...
A normal alarm stops when you tap a button.

Orisen checks whether you actually got out of bed.

### Slightly stronger explanation

Normal alarms trust your half-awake self.
...
The first layer is wake completion: the alarm does not fully stop just because you tapped a button. Orisen uses presence detection to check whether you actually left bed, and it can re-trigger if you return.

The bigger vision is a room-based sleep intervention system that uses sensing, audio, light, and feedback to make waking up feel less brutal over time.

## Main messaging wedge
...
- Dismissing an alarm is not wake completion.
- Your alarm can work perfectly and your morning can still fail.
...
Speak to people who say or feel things like:

- I set 8 alarms.
- I turn it off and go back to sleep.
- I wake up, but I do not get out of bed.
- I cannot trust myself in the morning.
- I somehow lose another hour after the alarm.
- I put my phone far away and still found a way around it.
- Normal alarms do not work on me anymore.
- Getting out of bed feels like a mission.
- I wake up feeling heavy, foggy, or brutal.
- I do not need another alarm sound. I need something that gets me out of bed.

Do not speak first to people who only want:

- sleep graphs
- sleep scores
- generic productivity tips
- a prettier alarm clock
- motivation quotes
- general wellness tracking

## Product language

Use these product phrases often:

- wake-completion system
- presence-based wake completion
- non-contact sleep intervention
- non-contact wake-up system
- checks whether you actually got out of bed
- built around the gap between alarm dismissal and leaving bed
- designed to make going back to sleep harder
- designed to protect your morning from your half-awake self
- local alarm execution
- re-trigger if you return to bed
...
- sleep-stage-aware wake intervention
...
> Orisen uses mmWave radar and machine learning for sensor-informed sleep intervention.
...
Use four levels of language.

### Level 1: Current product identity and safe claims

Use when describing what Orisen is and the first validated wedge.
...
Use when describing the intended product behavior without promising perfect outcomes.

Examples:

- Designed to make waking up harder to avoid.
- Designed to make going back to bed harder.
...
Use when selling the mission, roadmap, and product direction.

Examples:

- Our goal is to make groggy mornings feel like a design flaw, not a personality flaw.
- We are building toward less brutal wake-ups.
...
Use when clearly framed as future direction.

Examples:

- The long-term vision is a room-based sleep intervention system that senses, responds, and helps guide the sleep-to-wake transition.
...
## Bold but safe marketing language

Use lines like these:

- Your alarm is not the problem. What happens after it rings is the problem.
- Normal alarms stop when you tap a button. Orisen is built around whether you actually got up.
- Built for people who cannot trust themselves in the morning.
- A normal alarm trusts your half-awake self. Orisen does not.
- Stop designing mornings around willpower.
- If you can turn it off half-asleep, it was never a real wake-up system.
- Waking up is not done until you are out of bed.
- Orisen is built for the people who beat every normal alarm hack.
- The enemy is not sleep. The enemy is half-awake decision-making.
...
Use vision language when selling the bigger product direction.

Good vision lines:

- We are building toward a future where your room helps guide you out of sleep before your alarm has to fight you.
- The long-term goal is to make brutal wake-ups obsolete.
...
Avoid wording that sounds like the future outcome is already guaranteed.

## Current claims vs vision claims

| Claim type | Good wording | Avoid wording |
|---|---|---|
| Current product identity | Orisen is a non-contact sleep intervention device for people who struggle to wake up. | Orisen is a medical-grade sleep intervention device. |
| Wake completion | Orisen checks whether you actually got out of bed. | Orisen guarantees you will never oversleep. |
| Reliability | Designed to make waking up more reliable by responding to whether you leave bed. | Guarantees perfect wake-up reliability. |
| Grogginess | Being built toward less-groggy mornings. | Eliminates grogginess. |
| Sleep inertia | Exploring ways to make the sleep-to-wake transition less harsh. | Fixes sleep inertia. |
...
> An alarm that checks whether you actually got out of bed.

Subheadline:

> Orisen is a non-contact wake-up system for people who turn alarms off and go back to sleep.
...
> Orisen uses non-contact presence detection to keep the wake-up flow going until you actually leave bed.

### Hero direction 3

Headline:

> Waking up is not the same as getting up.
...
Use sharper, more founder-led versions on X and LinkedIn:

- I do not think alarms are the real problem. The real problem is that they trust you at the worst possible moment: when you are half awake.
- If your alarm stops before you leave bed, it is not solving wake-up. It is solving noise.
...
| Position Orisen as | Do not position Orisen as |
|---|---|
| Wake-completion system | Generic alarm clock |
| Non-contact sleep intervention device | Passive sleep tracker |
| Room-based wake-up system | Wearable replacement based on accuracy claims |
| Product for chronic wake-up failure | Casual wellness gadget |
...
- quantified research stats
- market size
- medical or clinical language

## Claims to avoid

Avoid these as public claims unless future evidence and review support them:

- Orisen eliminates grogginess.
- Orisen fixes sleep inertia.
- Orisen treats sleep inertia.
...
- Orisen replaces PSG or clinical sleep tracking.
...
## Acceptable stronger phrasing

These are stronger but acceptable if context makes the claim level clear:

- We are going after sleep inertia.
- Our goal is to make groggy wake-ups obsolete.
- We are building toward less brutal mornings.
- We are exploring sleep-phase-aware wake intervention.
- We are building toward radar and AI-guided wake intervention.
...
Customer interview language can inspire punchy copy.

Good use:

- Gets you out of bed.
- Need more than another phone alarm.
- Built for people who set too many alarms.
- Built for people who wake up but do not get up.

Careful use:

- “Wakes you up 100% of the time” appeared as ideal customer language, but should not be reused as a claim.

### Old MVP language

Safe use:

- An early prototype demonstrated the core wake-completion loop.
- Early testers perceived meaningful value in being forced or strongly pushed out of bed.
- Early testing suggested users still wanted wake-ups to feel less brutal.

Avoid:

- The old MVP proved Orisen works.
- Users proved they will pay.
- The old MVP solved grogginess.

### External research language
...
- Early founder-led marketing showed message resonance around the wake-up problem.
- A first organic post generated early waitlist interest.

Avoid:

- We have proven product-market fit.
- The market is validated.
- People have proven they will buy.
