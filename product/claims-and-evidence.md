...
| Product identity | Orisen as a sleep OS, OS for sleep, or bedroom OS. | Long-term vision metaphor, investor use only | "Orisen is building toward a sleep OS for the bedroom, starting with wake completion." "Orisen is building toward a bedroom interface for software-defined sleep interventions." | "Sleep OS" and "bedroom OS" mean a future architecture where a bedroom device supports multiple permissioned intervention layers. | "Orisen is a validated sleep OS." "Orisen's OS fixes sleep." "Orisen controls sleep through a bedroom OS." | Product overview and framing docs support platform-capable architecture and software-defined interventions as future direction. | Does not prove current OS-like completeness, validated AI agents, validated autonomous optimization, sleep-stage control, clinical efficacy, or broad sleep improvement. | Working multi-layer product behavior, tested user value, permission/override model, and evidence for each intervention layer. | [`product/product-overview.md`](product-overview.md), [`product/framing-and-narrative.md`](framing-and-narrative.md), [`fundraising/investor-narrative.md`](../fundraising/investor-narrative.md) |
| Product identity | Orisen as the physical layer or physical interface for sleep software. | Safe architecture framing when future-facing | "Orisen gives sleep software a physical interface in the bedroom." "Orisen is being built as a physical layer for future software-defined sleep interventions." | "Physical layer" means the device can sense and act in the room; it does not make software-only sleep intervention proven. | "All sleep problems become software-only." "Apps can now fix sleep through Orisen." "Orisen has the physical layer to solve every sleep problem." | Product overview defines hardware foundation plus software-defined intervention layers. | Does not prove future software interventions are built, safe, effective, autonomous, or sufficient without additional hardware, sensors, integrations, or validation. | Validate each software-defined intervention with technical tests and user outcome evidence. | [`product/product-overview.md`](product-overview.md), [`product/framing-and-narrative.md`](framing-and-narrative.md) |
| Product identity | Orisen fixes sleep or changes sleep. | Claim-sensitive; only careful long-term ambition | "Orisen is being built to change sleep and wake outcomes, starting with wake completion." "Orisen starts by solving a specific wake-up failure." | Use "fixes sleep" only as internal shorthand for the long-term ambition to move from observing to intervening. | "Orisen fixes sleep." "Orisen fixes all sleep problems." "Orisen guarantees better sleep." | Product docs support active intervention direction, not broad outcome validation. | Does not prove broad sleep improvement, clinical efficacy, solved sleep inertia, sleep-stage control, or all-context sleep optimization. | Direct evidence for each outcome claim, including wake reliability, grogginess, sleep quality, sleep onset, or other claimed results. | [`product/product-overview.md`](product-overview.md), [`product/framing-and-narrative.md`](framing-and-narrative.md) |
...
| AI sleep agents | Orisen as the hardware layer for AI sleep agents. | Long-term vision / future architecture direction | "Orisen is building toward the hardware layer for future AI sleep agents." | "Hardware layer" means a future device interface that could let software agents sense context and intervene through approved outputs. | "Orisen has validated AI sleep agents." "Orisen's AI sleep agents work today." "AI agents can already optimize sleep through Orisen." | Product overview, roadmap, and framing docs support possible future AI-assisted layers. | Does not prove agent capability, autonomous decisions, validated context sensing, sleep-stage sensing, vital-sign sensing, or improved outcomes. | Working agent-device prototype, permission model, context validation, intervention logs, user trust testing, and outcome evidence. | [`product/product-overview.md`](product-overview.md), [`product/roadmap.md`](roadmap.md), [`product/framing-and-narrative.md`](framing-and-narrative.md) |
| AI sleep agents | Orisen gives AI sleep agents a body and a voice in the bedroom. | Claim-sensitive long-term metaphor | "Future AI-assisted sleep agents may use Orisen as a body, voice, or physical interface in the bedroom." | Use as investor vision language only; "body" means physical output channels and sensing context, not embodied intelligence validated today. | "Orisen gives AI agents a validated body and voice today." "Orisen turns sleep agents into real-world systems today." "Orisen can sense, speak, adapt, and intervene autonomously today." | Product direction includes future voice, sensing, audio, light, and AI-assisted intervention layers. | Does not prove voice intervention, agent safety, autonomous behavior, user trust, adaptation quality, or real-world sleep improvement. | Voice prototypes, agent prototypes, user permission/override tests, trust/tolerance testing, and outcome comparisons. | [`product/product-overview.md`](product-overview.md), [`product/roadmap.md`](roadmap.md), [`product/framing-and-narrative.md`](framing-and-narrative.md) |
...
| Autonomous intervention | Autonomous sleep agents or physical AI system. | High-risk long-term vision only | "Future versions may explore autonomous sleep agents or physical AI-style sleep intervention inside explicit user-approved boundaries." | "Physical AI system" means future software plus device outputs acting in the room; it is not a current validation claim. | "Orisen is an autonomous sleep agent." "Orisen is a validated physical AI system." "Orisen autonomously fixes sleep." "Orisen can optimize the bedroom without user boundaries." | Product overview and roadmap allow autonomous intervention only as future direction. | Does not prove autonomous optimization, safety, trust, sleep improvement, agent intelligence, or production readiness. | Defined autonomy scope, safety and override rules, working prototypes, decision logs, failure-mode testing, and real-world outcome validation. | [`product/product-overview.md`](product-overview.md), [`product/roadmap.md`](roadmap.md) |
...
Use carefully for investor-facing vision:

> Orisen is building the hardware layer for future AI sleep agents.

Use carefully:

> Orisen gives sleep software a physical interface in the bedroom.

Use carefully:

> One hardware foundation, multiple software-defined sleep interventions.
...
### Sleep OS and bedroom OS wording

Use carefully for investor-facing vision:

> Orisen is building toward a sleep OS for the bedroom, starting with wake completion.

Use carefully:

> Orisen is building toward a bedroom interface for software-defined sleep interventions.

Avoid:

> Orisen is a validated sleep OS.

> Orisen's bedroom OS fixes sleep.

> Orisen controls sleep through an OS.
...
- "Orisen is a validated sleep OS."
- "Orisen's bedroom OS fixes sleep."
- "Orisen gives AI agents a validated body and voice today."
- "Orisen is a validated physical AI system."
- "Orisen's AI fixes your sleep."
- "Orisen has a proven AI sleep coach."
- "Orisen autonomously optimizes your sleep."
...
Investor metaphors such as sleep OS, bedroom OS, hardware layer for AI sleep agents, physical layer for sleep software, body and voice for AI sleep agents, autonomous sleep agents, and physical AI system are allowed only as future-facing platform direction with clear claim boundaries.
